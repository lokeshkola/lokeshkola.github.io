...
$('.nkh-grid-item').hover(
  function(){
		...
		$('.nkh-grid-item').each(function(step){
			...
			$('<img/>').addClass('nkh-grid-item-img-replacement').attr({ src: 'https://raw.githubusercontent.com/lokeshkola/lokeshkola.github.io/master/images/' + imgSetId + '-full.jpg'}).appendTo($('.nkh-grid-item-media', $(par))).delay(step * 100).fadeIn(250);
